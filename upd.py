    ...
    try:
        ...
        for request in new_requests:
            if request.request_reference in processed_requests:
                continue  # Skip duplicate requests
            ...
            processed_requests.add(request.request_reference)  # Mark as processed immediately
        ...
        if request_list:
            for req in request_list:
                ...
                # Ensure Slack notification is sent only once
